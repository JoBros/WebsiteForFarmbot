...
<body>
<h1 style="background-color: #333; font-family: Arial, Helvetica, sans-serif; padding: 15px; margin: 0px; color: white">
  Farmbotsteuerung</h1>
<div class="topnav">
...
<table class="links" style="padding-left: 300px; padding-top: 150px; width: 600px;">
  <tr>
    <td class="anzeigeStatus" style="visibility: hidden"></td>
    <td class="anzeigeStatus">
      <center>
        <Button id="A" class="anzeigeStatus">x ></Button>
      </center>
    </td>
    <td class="anzeigeStatus" style="visibility: hidden"></td>
  </tr>
  <tr>
    <td class="anzeigeStatus">
      <center>
        <Button id="W" class="anzeigeStatus">y <</Button>
      </center>
    </td>
    <td class="anzeigeStatus" style="visibility: hidden"></td>
    <td class="anzeigeStatus">
      <center>
        <Button id="S" class="anzeigeStatus">y ></Button>
      </center>
    </td>
  </tr>
  <tr>
    ...
    <td class="anzeigeStatus">
      <center>
        <Button id="D" class="anzeigeStatus">x <</Button>
      </center>
    </td>
    <td class="anzeigeStatus" style="visibility: hidden"></td>
  </tr>
  <tr>
    <td class="anzeigeStatus">
      <center>
        <Button id="Q" class="anzeigeStatus">z <</Button>
      </center>
    </td>
    <td class="anzeigeStatus" style="visibility: hidden"></td>
    <td class="anzeigeStatus">
      <center>
        <Button id="E" class="anzeigeStatus">z ></Button>
      </center>
    </td>
  </tr>
</table>
